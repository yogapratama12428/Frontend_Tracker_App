        ...
        <div className="flex flex-no-wrap">
                            ...
                            <ul aria-orientation="vertical" className=" py-6">
                                <li className="pl-6 cursor-pointer  text-sm leading-3 tracking-normal pb-4 pt-5 text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 xl:text-base md:text-2xl text-base">User</span>
                                    </div>
                                </li>
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Mobil</span>
                                    </div>
                                </li>
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Motor</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="border-t border-gray-300">
                                <div className="w-full flex items-center justify-between px-6 pt-1">
                                    <div className="flex items-center">
                                        ...
                                        <p className="md:text-xl text-gray-800 text-base leading-4 ml-2">Dhea</p>
                                    </div>
                                    <ul className="flex">
            ...
            <div className="w-full">
                        ...
                        <div className="w-1/2 hidden lg:flex">
                            <div className="w-full flex items-center pl-8 justify-end">
                                ...
                                <div className="flex items-center relative cursor-pointer" onClick={() => setProfile(!profile)}>
                                    ...
                                    <p className="text-gray-800 text-sm mx-3">Dhea</p>
                ...
                <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
                    ...
                    <div className="w-full h-full rounded ">{/* Place your content here */}
                        <>  
                            <CardStatus />
                            <MapExplore />
                        </>
