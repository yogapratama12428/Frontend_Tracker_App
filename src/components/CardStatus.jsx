const CardStatus = () => {
  return (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl px-8 py-6 flex items-center">
        ...
        <div className="ml-6">
            <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">45</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm tracking-normal font-normal leading-5">Users</p>
        </div>
    </div>
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl px-8 py-6 flex items-center">
        <div className="p-4 bg-indigo-700 rounded text-white">
        ...
        <div className="ml-6">
            <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">100</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm tracking-normal font-normal leading-5">Cars</p>
        </div>
    </div>
</div>
  )
